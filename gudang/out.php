...
<?php include '_base/menu.php'; ?>
  <div class="content-wrapper">
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        <li>
			<a href="lap-out.php" class="small-box-footer">
				<button type="button" class="btn btn-danger">
				<span class="fa fa-folder-open-o"></span> Laporan Material Keluar</button>
			</a>	
		</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
				<form name='input' method='POST' action='save/s-out.php' class='form-horizontal'>
					...
					<label class='col-sm-2 control-label'>Part No</label>
						...
						<select onchange="cek_database()" id="part_no" name="part_no">
							<option value='' selected>- Pilih -</option>
								<?php
									include "../koneksi.php";
									$out_brg = mysqli_query($koneksi,"SELECT * FROM stok");
									while ($row = mysqli_fetch_array($out_brg)) {
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Tanggal</label>
							<div class="col-sm-4">
						<input type='date' id='myDate' name='tgl' placeholder='Tanggal' class='form-control' autocomplete='off' required maxlength='50'>
					</div>
					</div>
					<div class='form-group'>

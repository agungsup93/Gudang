        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body"><br>
					<?php
					include '../koneksi.php';
					$data = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM in_barang WHERE id = '$_GET[id]'"));
					?>
					<?php
					echo"
...
$update = mysqli_query($koneksi, "UPDATE in_barang SET 
rfp			=	'$rfp', 
tgl			=	'$tgl', 
material	=	'$material', 
satuan		=	'$satuan',
lokasi		=	'$lokasi' WHERE id='$id'") or die(mysqli_error());
echo "<script>alert ('Data Telah Berhasil Dirubah'); document.location='lap-in.php' </script>";}
?>
